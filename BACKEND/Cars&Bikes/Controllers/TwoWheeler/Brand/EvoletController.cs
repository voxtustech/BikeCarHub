...
{
    public class EvoletController : Controller
    {
        private readonly TwoWheelerDB _context;
        public EvoletController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("evolet/dhanno")]
        public IActionResult Dhanno()
        {
            var bikeDetails = GetBikeDetails("Dhanno");
            return View("~/Views/TwoWheeler/Brand/Evolet/Dhanno.cshtml", bikeDetails);
        }
        [Route("evolet/pony")]
        public IActionResult Pony()
        {
            var bikeDetails = GetBikeDetails("Pony");
            return View("~/Views/TwoWheeler/Brand/Evolet/Pony.cshtml", bikeDetails);
        }
        [Route("evolet/derby")]
        public IActionResult Derby()
        {
            var bikeDetails = GetBikeDetails("Derby");
            return View("~/Views/TwoWheeler/Brand/Evolet/Derby.cshtml", bikeDetails);
        }
