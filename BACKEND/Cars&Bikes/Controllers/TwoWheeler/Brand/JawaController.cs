...
{
    public class JawaController : Controller
    {
        private readonly TwoWheelerDB _context;
        public JawaController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("jawa/jawa-350")]
        public IActionResult JAWA350()
        {
            var bikeDetails = GetBikeDetails("JAWA 350");
            return View("~/Views/TwoWheeler/Brand/Jawa/JAWA350.cshtml", bikeDetails);
        }
        [Route("jawa/jawa-42")]
        public IActionResult JAWA42()
        {
            var bikeDetails = GetBikeDetails("JAWA 42");
            return View("~/Views/TwoWheeler/Brand/Jawa/JAWA42.cshtml", bikeDetails);
        }
        [Route("jawa/jawa-42-bobber")]
        public IActionResult JAWA42Bobber()
        {
            var bikeDetails = GetBikeDetails("JAWA 42 Bobber");
            return View("~/Views/TwoWheeler/Brand/Jawa/JAWA42Bobber.cshtml", bikeDetails);
        }
        [Route("jawa/jawa-perak")]
        public IActionResult JAWAPerak()
        {
            var bikeDetails = GetBikeDetails("JAWA Perak");
            return View("~/Views/TwoWheeler/Brand/Jawa/JAWAPerak.cshtml", bikeDetails);
        }
