...
{
    public class ObenElectricController : Controller
    {
        private readonly TwoWheelerDB _context;
        public ObenElectricController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("oben-electric/oben-rorr-ez")]
        public IActionResult ObenRorrEZ()
        {
            var bikeDetails = GetBikeDetails("Oben Rorr EZ");
            return View("~/Views/TwoWheeler/Brand/ObenElectric/ObenRorrEZ.cshtml", bikeDetails);
        }
        [Route("oben-electric/oben-rorr")]
        public IActionResult ObenRorr()
        {
            var bikeDetails = GetBikeDetails("Oben Rorr");
            return View("~/Views/TwoWheeler/Brand/ObenElectric/ObenRorr.cshtml", bikeDetails);
        }
