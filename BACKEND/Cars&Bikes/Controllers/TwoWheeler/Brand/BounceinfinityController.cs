...
{
    public class BounceinfinityController : Controller
    {
        private readonly TwoWheelerDB _context;
        public BounceinfinityController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("bounce-infinity/infinity-e.1-plus")]
        public IActionResult InfinityE1Plus()
        {
            var bikeDetails = GetBikeDetails("Infinity E.1 Plus");
            return View("~/Views/TwoWheeler/Brand/Bounceinfinity/InfinityE1Plus.cshtml", bikeDetails);
        }
        [Route("bounce-infinity/infinity-e.1-le")]
        public IActionResult InfinityE1LE()
        {
            var bikeDetails = GetBikeDetails("Infinity E.1 LE");
            return View("~/Views/TwoWheeler/Brand/Bounceinfinity/InfinityE1LE.cshtml", bikeDetails);
        }
        [Route("bounce-infinity/infinity-e.1")]
        public IActionResult InfinityE1()
        {
            var bikeDetails = GetBikeDetails("Infinity E.1");
            return View("~/Views/TwoWheeler/Brand/Bounceinfinity/InfinityE1.cshtml", bikeDetails);
        }
