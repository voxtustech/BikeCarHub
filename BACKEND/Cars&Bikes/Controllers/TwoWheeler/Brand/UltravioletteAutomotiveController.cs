...
{
    public class UltravioletteAutomotiveController : Controller
    {
        private readonly TwoWheelerDB _context;
        public UltravioletteAutomotiveController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("ultraviolette-automotive/f77")]
        public IActionResult F77()
        {
            var bikeDetails = GetBikeDetails("F77");
            return View("~/Views/TwoWheeler/Brand/UltravioletteAutomotive/F77.cshtml", bikeDetails);
        }
        [Route("ultraviolette-automotive/f77-mach-2")]
        public IActionResult F77Mach2()
        {
            var bikeDetails = GetBikeDetails("F77 Mach 2");
            return View("~/Views/TwoWheeler/Brand/UltravioletteAutomotive/F77Mach2.cshtml", bikeDetails);
        }
