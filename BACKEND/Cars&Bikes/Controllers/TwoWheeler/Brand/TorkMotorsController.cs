...
{
    public class TorkMotorsController : Controller
    {
        private readonly TwoWheelerDB _context;
        public TorkMotorsController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("tork-motors/tork-kratos-x")]
        public IActionResult TorkKratosX()
        {
            var bikeDetails = GetBikeDetails("Tork Kratos X");
            return View("~/Views/TwoWheeler/Brand/TorkMotors/TorkKratosX.cshtml", bikeDetails);
        }
        [Route("tork-motors/tork-kratos-r")]
        public IActionResult TorkKratosR()
        {
            var bikeDetails = GetBikeDetails("Tork Kratos R");
            return View("~/Views/TwoWheeler/Brand/TorkMotors/TorkKratosR.cshtml", bikeDetails);
        }
