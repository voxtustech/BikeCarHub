...
{
    public class YezdiController : Controller
    {
        private readonly TwoWheelerDB _context;
        public YezdiController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("yezdi/yezdi-roadster")]
        public IActionResult YezdiRoadster()
        {
            var bikeDetails = GetBikeDetails("Yezdi Roadster");
            return View("~/Views/TwoWheeler/Brand/Yezdi/YezdiRoadster.cshtml", bikeDetails);
        }
        [Route("yezdi/yezdi-scrambler")]
        public IActionResult YezdiScrambler()
        {
            var bikeDetails = GetBikeDetails("Yezdi Scrambler");
            return View("~/Views/TwoWheeler/Brand/Yezdi/YezdiScrambler.cshtml", bikeDetails);
        }
        [Route("yezdi/yezdi-adventure")]
        public IActionResult YezdiAdventure()
        {
            var bikeDetails = GetBikeDetails("Yezdi Adventure");
            return View("~/Views/TwoWheeler/Brand/Yezdi/YezdiAdventure.cshtml", bikeDetails);
        }
