...
{
    public class MotoMoriniController : Controller
    {
        private readonly TwoWheelerDB _context;
        public MotoMoriniController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("moto-morini/moto-morini-calibro-bagger")]
        public IActionResult MotoMoriniCALIBROBAGGER()
        {
            var bikeDetails = GetBikeDetails("Moto Morini CALIBRO BAGGER");
            return View("~/Views/TwoWheeler/Brand/MotoMorini/MotoMoriniCALIBROBAGGER.cshtml", bikeDetails);
        }
        [Route("moto-morini/moto-morini-calibro-custom")]
        public IActionResult MotoMoriniCALIBROCUSTOM()
        {
            var bikeDetails = GetBikeDetails("Moto Morini CALIBRO CUSTOM");
            return View("~/Views/TwoWheeler/Brand/MotoMorini/MotoMoriniCALIBROCUSTOM.cshtml", bikeDetails);
        }
        [Route("moto-morini/moto-morini-x-cape")]
        public IActionResult MotoMoriniXCAPE()
        {
            var bikeDetails = GetBikeDetails("Moto Morini X-CAPE");
            return View("~/Views/TwoWheeler/Brand/MotoMorini/MotoMoriniXCAPE.cshtml", bikeDetails);
        }
        [Route("moto-morini/moto-morini-seiemmezzo-str")]
        public IActionResult MotoMoriniSEIEMMEZZOSTR()
        {
            var bikeDetails = GetBikeDetails("Moto Morini SEIEMMEZZO STR");
            return View("~/Views/TwoWheeler/Brand/MotoMorini/MotoMoriniSEIEMMEZZOSTR.cshtml", bikeDetails);
        }
        [Route("moto-morini/moto-morini-seiemmezzo-scr")]
        public IActionResult MotoMoriniSEIEMMEZZOSCR()
        {
            var bikeDetails = GetBikeDetails("Moto Morini SEIEMMEZZO SCR");
            return View("~/Views/TwoWheeler/Brand/MotoMorini/MotoMoriniSEIEMMEZZOSCR.cshtml", bikeDetails);
        }
