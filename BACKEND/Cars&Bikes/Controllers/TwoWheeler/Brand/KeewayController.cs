...
{
    public class KeewayController : Controller
    {
        private readonly TwoWheelerDB _context;
        public KeewayController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("keeway/keeway-sr125")]
        public IActionResult KeewaySR125()
        {
            var bikeDetails = GetBikeDetails("Keeway SR125");
            return View("~/Views/TwoWheeler/Brand/Keeway/KeewaySR125.cshtml", bikeDetails);
        }
        [Route("keeway/keeway-sr250")]
        public IActionResult KeewaySR250()
        {
            var bikeDetails = GetBikeDetails("Keeway SR250");
            return View("~/Views/TwoWheeler/Brand/Keeway/KeewaySR250.cshtml", bikeDetails);
        }
        [Route("keeway/keeway-k300n")]
        public IActionResult KeewayK300N()
        {
            var bikeDetails = GetBikeDetails("Keeway K300N");
            return View("~/Views/TwoWheeler/Brand/Keeway/KeewayK300N.cshtml", bikeDetails);
        }
        [Route("keeway/keeway-k300r")]
        public IActionResult KeewayK300R()
        {
            var bikeDetails = GetBikeDetails("Keeway K300R");
            return View("~/Views/TwoWheeler/Brand/Keeway/KeewayK300R.cshtml", bikeDetails);
        }
        [Route("keeway/keeway-k-light-250v")]
        public IActionResult KeewayKLight250V()
        {
            var bikeDetails = GetBikeDetails("Keeway K-Light 250V");
            return View("~/Views/TwoWheeler/Brand/Keeway/KeewayKLight250V.cshtml", bikeDetails);
        }
        [Route("keeway/keeway-sixties-300i")]
        public IActionResult KeewaySixties300i()
        {
            var bikeDetails = GetBikeDetails("Keeway Sixties 300i");
            return View("~/Views/TwoWheeler/Brand/Keeway/KeewaySixties300i.cshtml", bikeDetails);
        }
        [Route("keeway/keeway-vieste-300")]
        public IActionResult KeewayVieste300()
        {
            var bikeDetails = GetBikeDetails("Keeway Vieste 300");
            return View("~/Views/TwoWheeler/Brand/Keeway/KeewayVieste300.cshtml", bikeDetails);
        }
        [Route("keeway/keeway-v302c")]
        public IActionResult KeewayV302C()
        {
            var bikeDetails = GetBikeDetails("Keeway V302C");
            return View("~/Views/TwoWheeler/Brand/Keeway/KeewayV302C.cshtml", bikeDetails);
        }
