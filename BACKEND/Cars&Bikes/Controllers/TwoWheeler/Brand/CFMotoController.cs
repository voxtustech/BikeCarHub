...
{
    public class CFMotoController : Controller
    {
        private readonly TwoWheelerDB _context;
        public CFMotoController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("cf-moto/cf-moto-300nk")]
        public IActionResult CFMoto300NK()
        {
            var bikeDetails = GetBikeDetails("CF Moto 300NK");
            return View("~/Views/TwoWheeler/Brand/CFMoto/CFMoto300NK.cshtml", bikeDetails);
        }
        [Route("cf-moto/cf-moto-650mt")]
        public IActionResult CFMoto650MT()
        {
            var bikeDetails = GetBikeDetails("CF Moto 650MT");
            return View("~/Views/TwoWheeler/Brand/CFMoto/CFMoto650MT.cshtml", bikeDetails);
        }
        [Route("cf-moto/cf-moto-650nk")]
        public IActionResult CFMoto650NK()
        {
            var bikeDetails = GetBikeDetails("CF Moto 650NK");
            return View("~/Views/TwoWheeler/Brand/CFMoto/CFMoto650NK.cshtml", bikeDetails);
        }
        [Route("cf-moto/cf-moto-650gt")]
        public IActionResult CFMoto650GT()
        {
            var bikeDetails = GetBikeDetails("CF Moto 650GT");
            return View("~/Views/TwoWheeler/Brand/CFMoto/CFMoto650GT.cshtml", bikeDetails);
        }
