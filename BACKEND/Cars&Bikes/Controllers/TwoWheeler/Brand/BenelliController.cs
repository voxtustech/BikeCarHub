...
{
    public class BenelliController : Controller
    {
        private readonly TwoWheelerDB _context;
        public BenelliController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("benelli/benelli-naked")]
        public IActionResult BenelliNAKED()
        {
            var bikeDetails = GetBikeDetails("Benelli NAKED");
            return View("~/Views/TwoWheeler/Brand/Benelli/BenelliNAKED.cshtml", bikeDetails);
        }
        [Route("benelli/benelli-touring")]
        public IActionResult BenelliTOURING()
        {
            var bikeDetails = GetBikeDetails("Benelli TOURING");
            return View("~/Views/TwoWheeler/Brand/Benelli/BenelliTOURING.cshtml", bikeDetails);
        }
        [Route("benelli/benelli-leoncino")]
        public IActionResult BenelliLEONCINO()
        {
            var bikeDetails = GetBikeDetails("Benelli LEONCINO");
            return View("~/Views/TwoWheeler/Brand/Benelli/BenelliLEONCINO.cshtml", bikeDetails);
        }
