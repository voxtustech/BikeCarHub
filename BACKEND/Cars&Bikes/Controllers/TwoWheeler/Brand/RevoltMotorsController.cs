...
{
    public class RevoltMotorsController : Controller
    {
        private readonly TwoWheelerDB _context;
        public RevoltMotorsController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("revolt-motors/revolt-rv1")]
        public IActionResult RevoltRV1()
        {
            var bikeDetails = GetBikeDetails("Revolt RV1");
            return View("~/Views/TwoWheeler/Brand/RevoltMotors/RevoltRV1.cshtml", bikeDetails);
        }
        [Route("revolt-motors/revolt-rv1-plus")]
        public IActionResult RevoltRV1Plus()
        {
            var bikeDetails = GetBikeDetails("Revolt RV1 Plus");
            return View("~/Views/TwoWheeler/Brand/RevoltMotors/RevoltRV1Plus.cshtml", bikeDetails);
        }
        [Route("revolt-motors/revolt-rv400-brz")]
        public IActionResult RevoltRV400BRZ()
        {
            var bikeDetails = GetBikeDetails("Revolt RV400 BRZ");
            return View("~/Views/TwoWheeler/Brand/RevoltMotors/RevoltRV400BRZ.cshtml", bikeDetails);
        }
        [Route("revolt-motors/revolt-rv400")]
        public IActionResult RevoltRV400()
        {
            var bikeDetails = GetBikeDetails("Revolt RV400");
            return View("~/Views/TwoWheeler/Brand/RevoltMotors/RevoltRV400.cshtml", bikeDetails);
        }
