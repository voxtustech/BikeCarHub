...
{
    public class AtherEnergyController : Controller
    {
        private readonly TwoWheelerDB _context;
        public AtherEnergyController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("ather-energy/ather-ritza")]
        public IActionResult AtherRitza()
        {
            var bikeDetails = GetBikeDetails("Ather Ritza");
            return View("~/Views/TwoWheeler/Brand/AtherEnergy/AtherRitza.cshtml", bikeDetails);
        }
        [Route("ather-energy/ather-450")]
        public IActionResult Ather450()
        {
            var bikeDetails = GetBikeDetails("Ather 450");
            return View("~/Views/TwoWheeler/Brand/AtherEnergy/Ather450.cshtml", bikeDetails);
        }
        [Route("ather-energy/ather-450-apex")]
        public IActionResult Arther450Apex()
        {
            var bikeDetails = GetBikeDetails("Ather 450 Apex");
            return View("~/Views/TwoWheeler/Brand/AtherEnergy/Arther450Apex.cshtml", bikeDetails);
        }
