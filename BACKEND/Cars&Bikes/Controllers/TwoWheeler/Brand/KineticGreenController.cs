...
{
    public class KineticGreenController : Controller
    {
        private readonly TwoWheelerDB _context;
        public KineticGreenController(TwoWheelerDB context)
        {
            _context = context;
        }
        ...
        [Route("kinetic-green/e-zulu")]
        public IActionResult EZulu()
        {
            var bikeDetails = GetBikeDetails("E-Zulu");
            return View("~/Views/TwoWheeler/Brand/KineticGreen/EZulu.cshtml", bikeDetails);
        }
        [Route("kinetic-green/zoom")]
        public IActionResult Zoom()
        {
            var bikeDetails = GetBikeDetails("Zoom");
            return View("~/Views/TwoWheeler/Brand/KineticGreen/Zoom.cshtml", bikeDetails);
        }
        [Route("kinetic-green/flex")]
        public IActionResult Flex()
        {
            var bikeDetails = GetBikeDetails("Flex");
            return View("~/Views/TwoWheeler/Brand/KineticGreen/Flex.cshtml", bikeDetails);
        }
        [Route("kinetic-green/zing")]
        public IActionResult Zing()
        {
            var bikeDetails = GetBikeDetails("Zing");
            return View("~/Views/TwoWheeler/Brand/KineticGreen/Zing.cshtml", bikeDetails);
        }
