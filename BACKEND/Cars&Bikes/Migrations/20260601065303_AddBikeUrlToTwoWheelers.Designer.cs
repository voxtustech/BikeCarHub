...
namespace Cars_Bikes.Migrations
{
    ...
    [Migration("20260601065303_AddBikeUrlToTwoWheelers")]
    partial class AddBikeUrlToTwoWheelers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cars_Bikes.Models.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cars_Bikes.Models.Review", b =>
                {
            ...
            modelBuilder.Entity("Cars_Bikes.Models.Wishlist", b =>
                {
            ...
            modelBuilder.Entity("Cars_Bikes.Models.Wishlist", b =>
                {
                    b.HasOne("Cars_Bikes.Models.TwoWheeler", "TwoWheelers")
                        .WithMany()
                        .HasForeignKey("TwoWheelerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Cars_Bikes.Models.ApplicationUser", null)
                        .WithMany()
